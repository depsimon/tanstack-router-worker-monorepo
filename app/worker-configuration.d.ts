/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings --env dev` (hash: XXX)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BUCKET_PUBLIC_URL" | "NO_COLOR" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "CLOUDFLARE_ENV" | "RESEND_API_KEY">> {}
}
